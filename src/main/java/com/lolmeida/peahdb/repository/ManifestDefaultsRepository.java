...
public class ManifestDefaultsRepository implements PanacheRepository<ManifestDefault> {
    ...
    public List<ServiceCategory> findAllActiveCategories() {
        return ServiceCategory.<ServiceCategory>find("isActive = true ORDER BY name").list();
    }
    ...
    public Optional<ServiceCategory> findCategoryByName(String categoryName) {
        return ServiceCategory.<ServiceCategory>find("name = ?1 AND isActive = true", categoryName)
                .firstResultOptional();
    }
    ...
    public long countActiveCategories() {
        return ServiceCategory.count("isActive = true");
    }
    ...
    public long countManifestDefaultsByCategory(String categoryName) {
        return count("category.name = ?1 AND isActive = true", categoryName);
    }
    ...
    public long countAuthDefaultsByCategory(String categoryName) {
        return AuthDefault.count("category.name = ?1 AND isActive = true", categoryName);
    }
    ...
    public boolean categoryExists(String categoryName) {
        return ServiceCategory.count("name = ?1 AND isActive = true", categoryName) > 0;
    }
